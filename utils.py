...
def create_function_pb(problem_name, descriptor_file):

    if isinstance(problem_name, int):
        string_hardcoded = f"def ex{problem_name}(param): \n\tpass\n\n"
    else:
        string_hardcoded = f"def {problem_name}(param): \n\tpass\n\n"
    descriptor_file.write(string_hardcoded)


def create_function_subpb(problem_name, sub_problem_name, descriptor_file):
    string_hardcoded = f"def ex{problem_name}_{sub_problem_name}(param): \n\tpass\n\n"
    descriptor_file.write(string_hardcoded)
